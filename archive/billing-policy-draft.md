...
*   **Pricing:** [PRIMARY CURRENCY AND PRICE TBD â€” requires pricing/tax decision].
*   **Tax/VAT Exclusion:** The base pricing does **not** include localized taxes (such as EU VAT or state-level sales taxes). [Tax calculation and local tax dynamic inclusion are TBD â€” requires tax setup decisions].
