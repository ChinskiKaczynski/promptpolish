...
# PromptPolish â€” SaaS Operations Runbook & Support Playbook
...
*   **Prompt Analyses (`prompt_analyses`)**: Anonymized/deleted after **30 days** â€” *EXCEPT* active shared records (`is_share_enabled = true` and `deleted_at IS NULL`) which are preserved permanently to keep public links active.
