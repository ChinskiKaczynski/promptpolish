...
# Executable Launch Checklist (v1.0) â€” PromptPolish
...
- [v1-product-freeze-review.md](./v1-product-freeze-review.md) â€” Feature freeze status and locked engine modules.
- [v1-production-smoke-test-plan.md](./v1-production-smoke-test-plan.md) â€” Manual smoke tests and environment configurations.
- [pre-production-launch-checklist.md](./pre-production-launch-checklist.md) â€” Pre-launch engineering and compliance roadmap.
- [stripe-test-mode-checklist.md](./stripe-test-mode-checklist.md) â€” Local and staging Stripe sandbox testing.
- [legal-readiness.md](./legal-readiness.md) â€” GDPR, tax details, and sub-processor agreements.
- [operations-runbook.md](./operations-runbook.md) â€” Operations logging, retention crons, and support playbooks.
- [production-smoke-test.md](./production-smoke-test.md) â€” Visual design, layout, and copy validation checklists.
...
- [ ] **Past_Due Grace Period Verification**:
  ...
  - [ ] Confirm `/account` displays the **ZalegĹ‚oĹ›Ä‡ w pĹ‚atnoĹ›ci (Grace Period)** warning.
...
- [ ] **Unpaid/Canceled Downgrade Policy**:
  ...
  - [ ] Verify `/account` changes the tier badge to Free and shows **DostÄ™p zawieszony (Access Suspended)**.
...
| :--- | :--- | :--- | :--- | :---: | :--- |
| **Technical Readiness** | Release Manager | đźź˘ Pass | [v1-product-freeze-review.md](./v1-product-freeze-review.md#9-verification-results--command-output) | No | Lints, unit tests, and production builds complete cleanly. |
| **Product Smoke Checks** | QA Lead | đźź˘ Pass | [v1-production-smoke-test-plan.md](./v1-production-smoke-test-plan.md#2-test-phases) | No | Basic audit flow, private security, and markdown exports verified. |
| **Stripe Test Mode** | Billing Engineer | đźź˘ Pass | [stripe-test-mode-checklist.md](./stripe-test-mode-checklist.md#4-test-scenarios) | No | Webhook event routing and portal downgrades verified in staging. |
| **Legal Entity Details** | Business Owner | đź”´ Pending | [legal-readiness.md](./legal-readiness.md#5-stripe-production-readiness-blockers-checklist) | **YES** | Corporate name, address, and compliance inboxes TBD. |
| **Counsel Review** | Legal Counsel | đź”´ Pending | [legal-readiness.md](./legal-readiness.md#6-consolidated-list-of-unresolved-legal-tax-and-gdpr-questions) | **YES** | Terms of service and privacy policy draft reviews incomplete. |
| **Tax Compliance** | Tax Advisor | đź”´ Pending | [legal-readiness.md](./legal-readiness.md#6-consolidated-list-of-unresolved-legal-tax-and-gdpr-questions) | **YES** | VAT OSS registration and Stripe Tax configuration details pending. |
| **Sub-processor DPAs** | Business Owner | đź”´ Pending | [legal-readiness.md](./legal-readiness.md#5-stripe-production-readiness-blockers-checklist) | **YES** | Signed DPAs with Vercel, Supabase, Stripe, and AI provider pending. |
| **Production Key Promo** | Release Manager | đź”´ Pending | [v1-production-smoke-test-plan.md](./v1-production-smoke-test-plan.md#2-test-phases) | **YES** | Production webhook registration and Stripe Live Mode keys locked. |
