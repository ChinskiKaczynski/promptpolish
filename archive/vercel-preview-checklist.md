...
| **`OPENROUTER_MODEL_ID`**                  |     Server     |      `string`      | Target model ID. Defaults to `openrouter/owl-alpha`.                                                                                                 |
...
21. [ ] **Retention Cleanup Dry-Run**: Run the retention cleanup locally targeting your preview database:
    ...
    ```
    Confirm it securely returns the counts of expired data _without_ deleting any rows.
