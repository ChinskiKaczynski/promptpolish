  ...
  return (
    <div className="grid gap-6 sm:grid-cols-2">
      <label className="space-y-2 text-sm font-semibold text-slate-800 block">
        ...
        <input 
          className="w-full rounded-2xl border border-slate-200 bg-slate-50/40 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 focus:outline-none px-4 py-3.5 text-sm transition shadow-sm"
