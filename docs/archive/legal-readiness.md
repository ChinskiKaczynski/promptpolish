...
*   **ePrivacy Assessment:** This cookie is classified as **strictly necessary** to deliver the requested core service (retaining user ownership of their anonymous `/result/[id]` reports over multiple visits). Without this cookie, the user cannot access their private results (preliminary assessment â€” legal review required).
...
1.  **Draft Terms of Service:**  
    ...
    đź‘‰ **[terms-of-service-draft.md](./terms-of-service-draft.md)**
2.  **Draft Privacy Policy:**  
    ...
    đź‘‰ **[privacy-policy-draft.md](./privacy-policy-draft.md)**
3.  **Draft Billing, Refund & Cancellation Policy:**  
    ...
    đź‘‰ **[billing-policy-draft.md](./billing-policy-draft.md)**
4.  **Vendor & Data Processor Inventory:**  
    ...
    đź‘‰ **[vendor-inventory.md](./vendor-inventory.md)**
5.  **Refund & Cancellation Policy (Historical Draft):**  
    ...
    đź‘‰ **[refund-cancellation-policy.md](./refund-cancellation-policy.md)**
6.  **Data Deletion Request Flow Draft:**  
    ...
    đź‘‰ **[data-deletion-flow.md](./data-deletion-flow.md)**
...
*   **Live Payment Claims:** No claims are made that production checkouts are live. When `STRIPE_ENABLED=false` is detected on the server, a highly visible banner is displayed: *"Beta: Bramka pĹ‚atnoĹ›ci Stripe jest wyĹ‚Ä…czona. Zakup Pro jest niedostÄ™pny â€” moĹĽesz testowaÄ‡ symulacjÄ™ Pro po zalogowaniu."*
...
- [ ] **Execute Sub-processor DPAs (preliminary assessment â€” legal review required):** Formally execute Data Processing Addendums containing standard contractual clauses (SCCs) with:
...
6.  **Stripe Invoicing Retention vs. Right to Erasure:** Does retaining customer personal data on Stripe billing invoices for tax compliance (legally mandated for 5â€“7 years) comply with GDPR Article 17(3)(b) when a user requests complete account deletion?
