# Operator Runbook — PromptPolish v1.0
...
*   **Logged-In Users:**
    ...
    *   **Stripe Billing Data Caveat:** Tax regulations require retention of invoice records for 5–7 years. The billing information must be archived in Stripe and is shielded from complete GDPR erasure under regulatory compliance exemptions.
