...
*   **Model Profile Selector**: Supporting only `general-llm` and `google-gemini-3-5-flash`.
...
*   **Vercel AI SDK Structured Engine**: Prompts Gemini using the strict `Output.object` format to gather structured criterion scores and critiques.
