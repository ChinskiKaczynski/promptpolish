...
*   **Pricing:** Subscription rates are billed on a monthly recurring basis ([PRIMARY CURRENCY AND PRICE TBD — requires pricing/tax decision]).
...
## 12. Governing Law
These Terms shall be governed by and construed in accordance with the laws of [GOVERNING LAW JURISDICTION TBD — requires legal decision], without regard to its conflict of law principles.
