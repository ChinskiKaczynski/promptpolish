...
test.describe('Pro Authenticated Flows', () => {
  ...
  test('Pro: dashboard shows Pro plan and session persists', async ({ page }) => {
    ...
    // history does not contain Free user's prompt
    await page.goto('/history')
    await expect(page.locator('body')).not.toContainText('uzytkownika Free')
  })

  test('Pro: PDF export downloads file successfully', async ({ page }) => {
